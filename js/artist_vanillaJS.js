...
.then(json => {
        ...
        for (let category in artists[artist]) {
            ...
            if (["feat","visualize"].includes(category)) {
                ...
                for (let subCat in artists[artist][category]) {
                    let subCatTemplate = document.querySelector("#categoryTemplate").content.cloneNode(true);
    ...
    document.querySelector("#selectMode").addEventListener("change", event => {
        ...
        selectAttribute(`#${(select != "title")? "artistUl" : "titleUl"}`, "hidden", false, true, ...document.querySelectorAll("#artistUl, #titleUl"));
        ...
        if (select == "all") {
            ...
            selectAttribute(`.${select}`, "hidden", false, true, ...document.querySelectorAll(".artistLi, .categoryLi"));
        }
        toggleAttribute("style.listStyleType", (select == "all")? "" : "none", ...document.querySelectorAll(".categoryLi"));
